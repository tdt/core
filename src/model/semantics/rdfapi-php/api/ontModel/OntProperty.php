...
class OntProperty extends OntResource {
     ...
     * @access	public
     */
    public function OntProperty($uri = null) {
     ...
     * @access	public
     */
    public function addDomain($resResource) {
     ...
     * @access	public
     */
    public function addRange($resResource) {
     ...
     * @access	public
     */
    public function addSubProperty($resProperty) {
     ...
     * @access	public
     */
    public function addSuperProperty($resProperty) {
     ...
     * @access	public
     */
    public function hasDomain($resResource) {
     ...
     * @access	public
     */
    public function hasRange($resResource) {
     ...
     * @access	public
     */
    public function hasSubProperty($resProperty, $direct = true) {
        if ($direct)
     ...
     * @access	public
     */
    public function hasSuperProperty($resProperty, $direct = true) {
        if ($direct)
     ...
     * @access	public
     */
    public function listSubProperties($direct = true) {
        $return = array();
        if ($direct) {
     ...
     * @access	public
     */
    public function listSuperProperties($direct = true) {
        $return = array();
        if ($direct)
     ...
     * @access	public
     */
    public function removeDomain($resResource) {
     ...
     * @access	public
     */
    public function removeRange($resResource) {
     ...
     * @access	public
     */
    public function removeSubProperty($resProperty) {
     ...
     * @access	public
     */
    public function removeSuperProperty($resProperty) {
     ...
     * @access	public
     */
    public function setDomain($resResource) {
     ...
     * @access	public
     */
    public function setRange($resResource) {
     ...
     * @access	public
     */
    public function setSubProperty($resProperty) {
     ...
     * @access	public
     */
    public function setSuperProperty($resProperty) {
