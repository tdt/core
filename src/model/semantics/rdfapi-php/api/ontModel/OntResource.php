...
class OntResource extends ResResource {
     ...
     * @access	public
     */
    public function OntResource($uri = null) {
        $this->rdfType = false;
     ...
     * @access	public
     */
    public function addIsDefinedBy($resResource) {
     ...
     * @access	public
     */
    public function addLabelProperty($resLiteral) {
     ...
     * @access	public
     */
    public function addRDFType($resResource) {
     ...
     * @access	public
     */
    public function addSeeAlso($resResource) {
     ...
     * @access	public
     */
    public function getPropertyValue($property, $returnType = 'ResResource') {
     ...
     * @access	public
     */
    public function hasComment($resLiteral) {
     ...
     * @access	public
     */
    public function hasLabelProperty($resLiteral) {
     ...
     * @access	public
     */
    public function hasRDFType($ontClass) {
     ...
     * @access	public
     */
    public function hasSeeAlso($resResource) {
     ...
     * @access	public
     */
    public function isDefinedBy($resResource) {
     ...
     * @access	public
     */
    public function listComments($language) {
     ...
     * @access	public
     */
    public function listIsDefinedBy() {
     ...
     * @access	public
     */
    public function listLabelProperties($language = false) {
     ...
     * @access	public
     */
    public function listRDFTypes($direct = true) {
     ...
     * @access	public
     */
    public function listProperty($property, $returnType = 'OntResource') {
        $return = array();
     ...
     * @access	public
     */
    public function removeComment($resLiteral) {
     ...
     * @access	public
     */
    public function removeDefinedBy($resResource) {
     ...
     * @access	public
     */
    public function removeLabelProperty($resLiteral) {
     ...
     * @access	public
     */
    public function removeProperty($property, $value) {
     ...
     * @access	public
     */
    public function removeRDFType($resResource) {
     ...
     * @access	public
     */
    public function removeSeeAlso($resResource) {
     ...
     * @access	public
     */
    public function setComment($resLiteral) {
     ...
     * @access	public
     */
    public function setIsDefinedBy($resResource) {
     ...
     * @access	public
     */
    public function setLabelProperty($resLiteral) {
     ...
     * @access	public
     */
    public function setRDFType($resResource) {
     ...
     * @access	public
     */
    public function setSeeAlso($resResource) {
     ...
     * @access	private
     */
    public function _getSuperAttributeStatementsRec(& $startResource, & $attribute, & $attributeIndex, $onlyFindThisResResource = false) {
     ...
     * @access	private
     */
    public function _getSubAttributeStatementsRec(& $startResource, & $attribute, & $attributeIndex, $onlyFindThisResResource = false) {
     ...
     * @access	public
     */
    public function setInstanceRdfType($resResource) {
     ...
     * @access	public
     */
    public function getInstanceRdfType() {
        return $this->rdfType;
    }
