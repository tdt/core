...
class RssParser extends Object {
     ...
     * @param $nmsp the
     */
    public function image(&$model, &$rss, &$bnOrg, &$nmsp) {
     ...
     * @param $nmsp the
     */
    public function items(&$model, &$rss, &$bnOrg, &$nmsp) {
     ...
     */
    public function dc(&$node, &$model, &$dc) {
     ...
     */
    public function sy(&$node, &$model, &$sy) {
     ...
     * @param $nmsp the
     */
    public function channel(&$model, &$rss, &$node, &$nmsp, $type) {
        // Channel
