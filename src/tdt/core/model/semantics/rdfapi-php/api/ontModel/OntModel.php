...
class OntModel extends ResModel {
     ...
     * @access	public
     */
    public function OntModel(& $model, & $vocabulary) {
     ...
     * @access	public
     */
    public function createOntClass($uri = null) {
     ...
     * @access	public
     */
    public function createIndividual($uri = null) {
     ...
     * @access	public
     */
    public function createOntProperty($uri = null) {
