 ...
 *
 * @version  $Id$
 * @author Tobias Gau� <tobias.gauss at web.de>
 *
 * @package utility
 * @access	public
 *
...
class ModelComparator extends Object {
     ...
     * @return boolean
     */
    public function compare($thisModel, $thatModel) {
     ...
     * @return Array
     */
    public function buildSortArray($tripleList) {
        $sortedArray = Array();
     ...
     * @return Array
     */
    public function renameBlanks($sortedArray) {
        $i = 0;
        $labelmap = Array();
     ...
     * @return boolean
     */
    public function compareTriples($array1, $array2) {
