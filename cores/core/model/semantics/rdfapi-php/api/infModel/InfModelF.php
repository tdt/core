...
class InfModelF extends InfModel {
     ...
     * @access	public
     */
    public function InfModelF($baseURI = NULL) {
     ...
     * @access	private
     */
    public function applyInference() {
     ...
     * @access	public
     */
    public function entailStatement(& $statement) {
     ...
     * @access	private
     */
    public function _entailStatementRec($statement, & $infStatementsIndex) {
        $infStatements = array();
        $return = array();
        ...
        if ($this->contains($statement)) {
            ...
            //get the position of all matching statements
                ...
                do {
                    ...
                    $statementPosition =
                            $this->findFirstMatchOff($statement->getSubject(), $statement->getPredicate(), $statement->getObject(), $statementPosition + 1);
