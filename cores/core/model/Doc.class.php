...
class Doc{
    ...
    public function visitAll($factories){
        $c = Cache::getInstance();
        $doc = $c->get(Config::get("general","hostname") . Config::get("general","subdir") . "documentation");
        if(is_null($doc)){
            $doc = new stdClass();
            foreach($factories as $factory){ 
                $factory->makeDoc($doc);
            }
            $c->set(Config::get("general","hostname") . Config::get("general","subdir") . "documentation",$doc,60*60*60); // cache it for 1 hour by default
        }
        return $doc;
    }
    ...
    public function visitAllPackages(){
        $c = Cache::getInstance();
        $doc = $c->get(Config::get("general","hostname") . Config::get("general","subdir") . "packagedocumentation");
        if(is_null($doc)){
            $doc = new stdClass();
            ...
            $c->set(Config::get("general","hostname") . Config::get("general","subdir") . "packagedocumentation",$doc,60*60*60); // cache it for 1 hour by default
        }
        return $doc;
    ...
    public function visitAllDescriptions($factories){
        $c = Cache::getInstance();
        $doc = $c->get(Config::get("general","hostname") . Config::get("general","subdir") . "descriptiondocumentation");
        if(is_null($doc)){
            $doc = new stdClass();
            foreach($factories as $factory){ 
                $factory->makeDescriptionDoc($doc);
            }
            $c->set(Config::get("general","hostname") . Config::get("general","subdir") . "descriptiondocumentation",$doc,60*60*60); // cache it for 1 hour by default
        }
        return $doc;
    }
    ...
    public function visitAllAdmin($factories){
        $c = Cache::getInstance();
        $doc = $c->get(Config::get("general","hostname") . Config::get("general","subdir") . "admindocumentation");
        if(is_null($doc)){
            $doc = new stdClass();
            foreach($factories as $factory){ 
            ...
            $c->set(Config::get("general","hostname") . Config::get("general","subdir") . "admindocumentation",$doc,60*60*60); // cache it for 1 hour by default
        }
        return $doc;
    }
    ...
    public function visitAllFormatters(){
        $c = Cache::getInstance();
        $doc = $c->get(Config::get("general","hostname") . Config::get("general","subdir") . "formatterdocs");
        $ff = FormatterFactory::getInstance();
        if(is_null($doc)){
            $doc = $ff->getFormatterDocumentation();
            $c->set(Config::get("general","hostname") . Config::get("general","subdir") . "formatterdocs",$doc,60*60*60);
        }
        return $doc;
    }
    ...
    public function visitAllVisualizations(){
        $c = Cache::getInstance();
        $doc = $c->get(Config::get("general","hostname") . Config::get("general","subdir") . "visualizationdocs");
        $ff = FormatterFactory::getInstance();
        if(is_null($doc)){
            $doc = $ff->getVisualizationDocumentation();
            $c->set(Config::get("general","hostname") . Config::get("general","subdir") . "visualizationdocs",$doc,60*60*60);
        }
        return $doc;
    }
}
