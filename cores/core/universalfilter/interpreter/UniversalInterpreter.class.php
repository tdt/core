 ...
 */
include_once("cores/core/universalfilter/interpreter/IInterpreterControl.class.php");

include_once("cores/core/universalfilter/interpreter/executers/UniversalFilterExecuters.php");
