    ...
    private function seedCsv()
    {
        ...
        foreach ($csv_data as $file => $definition_info) {
            ...
            if (empty($definition)) {
                ...
                $csv_def->start_row = 0;
                $csv_def->title = "Autogenerated demo dataset";
                $csv_def->save();
                ...
                //$definition->title = "Autogenerated demo dataset";
                $definition->description = $csv_def->description;
                $definition->save();
    ...
    private function seedXml()
    {
        ...
        foreach ($xml_data as $file => $description) {
            ...
            if (empty($definition)) {
                ...
                $xml_def->title = "Autogenerated demo dataset";
                $xml_def->save();
                ...
                //$definition->title = "Autogenerated demo dataset";
                $definition->description = $xml_def->description;
                $definition->save();
    ...
    private function seedJson()
    {
        ...
        foreach ($json_data as $file => $description) {
            ...
            if (empty($definition)) {
                ...
                $json_def->title = "Autogenerated demo dataset";
                $json_def->save();
                ...
                //$definition->title = "Autogenerated demo dataset";
                $definition->description = $json_def->description;
                $definition->save();
    ...
    private function seedXls()
    {
        ...
        foreach ($xls_data as $file => $definition_info) {
            ...
            if (empty($definition)) {
                ...
                $xls_def->start_row = 0;
                $xls_def->title = "Autogenerated demo dataset";
                $xls_def->save();
                ...
                //$definition->title = "Autogenerated demo dataset";
                $definition->description = $xls_def->description;
                $definition->save();
    ...
    private function seedShp()
    {
        ...
        foreach ($shp_data as $directory => $info) {
            ...
            if (empty($definition)) {
                ...
                $shp_def->epsg = 4326;
                $shp_def->title = "Autogenerated demo dataset";
                $shp_def->save();
                ...
                //$definition->title = "Autogenerated demo dataset";
                $definition->description = $shp_def->description;
                $definition->save();
