...
#
# (22) filter :=  filterargument  '>'  string
#
$result = reset($tokens);
$a =& $tokens[0];
$b =& $tokens[2];
...
#
# (23) filter :=  filterargument  '<'  string
#
$result = reset($tokens);
$a =& $tokens[0];
$b =& $tokens[2];
...
#
# (26) filter :=  filterargument  EQ  num
#
$result = reset($tokens);
$a =& $tokens[0];
$b =& $tokens[2];
...
#
# (27) filter :=  filterargument  EQ  string
#
$result = reset($tokens);
$a =& $tokens[0];
$b =& $tokens[2];
...
#
# (28) filter :=  filterargument  '~'  string
#
$result = reset($tokens);
$a =& $tokens[0];
$b =& $tokens[2];
...
#
# (29) filter :=  filterargument  NE  string
#
$result = reset($tokens);
$a =& $tokens[0];
$b =& $tokens[2];
...
#
# (30) filter :=  filterargument  NE  num
#
$result = reset($tokens);
$a =& $tokens[0];
$b =& $tokens[2];
...
#
# (31) filter :=  filterargument  GE  string
#
$result = reset($tokens);
$a =& $tokens[0];
$b =& $tokens[2];
...
#
# (32) filter :=  filterargument  GE  num
#
$result = reset($tokens);
$a =& $tokens[0];
$b =& $tokens[2];
...
#
# (33) filter :=  filterargument  LE  string
#
$result = reset($tokens);
$a =& $tokens[0];
$b =& $tokens[2];
...
#
# (34) filter :=  filterargument  LE  num
#
$result = reset($tokens);
$a =& $tokens[0];
$b =& $tokens[2];
...
#
# (35) filter :=  filterargument  '('  num  ','  num  ','  num  ')'
#
$result = reset($tokens);
$function =& $tokens[0];
$lat =& $tokens[2];
