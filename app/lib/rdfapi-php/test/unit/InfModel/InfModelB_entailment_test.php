...
// ----------------------------------------------------------------------------------
// Class: testInfModelBEntailmentTests
// ----------------------------------------------------------------------------------

/**
 * Tests the basic operations of the RDFS & RDFSB Inf Models
 *
 * @version  $Id: InfModelB_entailment_test.php 321 2006-11-21 09:58:11Z tgauss $
...
class testInfModelBEntailmentTests extends UnitTestCase {
	...
	*/
	function test1()
	{
		$inf= new InfModelB('http://myInfModelB.com');
		$result= new MemModel();
		$parser= new N3Parser();
