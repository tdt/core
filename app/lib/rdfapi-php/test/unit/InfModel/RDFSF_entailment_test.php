 ...
 *
 * @version  $Id: RDFSF_entailment_test.php 321 2006-11-21 09:58:11Z tgauss $
...
class testRDFSEntailmentTests extends UnitTestCase {
	...
	*/
	function test1()
	{
		$inf= new RDFSFModel('http://myRDFSFModel.com');
		$result= new MemModel();
		$parser= new N3Parser();
