 ...
 * 
 * @version $Id: custom_test2.php 268 2006-05-15 05:28:09Z tgauss $
...
if (!isset($_POST['submit']) OR (strlen($_POST['RDF'])>1000000)) {?>
...
if ((isset($_POST['submit']) AND (strlen($_POST['RDF'])>1000000))) {echo "<center><h2>We're sorry, but your RDF is bigger than the allowed size</h2></center>";}; 
