...
                                 La propriété sélectionnée sera utilisée comme identifiant unique sur les objets qui seront mises en correspondance avec le format de sortie",
    ...
    'definition_rights'                 => 'Licence',
    'definition_rights_desc'            => 'La license associée avec les données.',
    'definition_theme'                  => 'Thème',
    'definition_theme_desc'             => 'Le thème associée aved les données.',
    'geodcat_geometry'                  => 'Géométrie',
    'geodcat_geometry_desc'             => "Un document JSON qui représente la pertinence géographique de l'ensemble de données.",
    'geodcat_label'                     => 'Label',
    'geodcat_label_desc'                => 'Une description de la zone géographique sélectionnée.',
    'geodcat_attribution'               => 'Attribution',
    'geodcat_attribution_desc'          => 'Les gens qui jouent un rôle impliquant cet ensemble de données.',
    'role_author'                       => 'Auteur',
    'role_author_desc'                  => "Partie qui est l'auteur de la ressource.",
    'role_custodian'                   => 'Guardien',
    'role_custodian_desc'              => "Partie qui accepte la responsabilité des données et assure des soins et l'entretien de la ressource appropriée.",
    'json_uri'                          => 'URI',
    ...
    'json_jsontype'                     => 'Type JSON',
    'json_jsontype_desc'                => 'Indique si le document JSON est plaine ou a une structure spécifique.',
    ...
    'mongo_mongo_collection_desc'       => 'Le nom de la collection MongoDB',
    'mongo_port'                        => 'Port',
    ...
    'mysql_mysql_host'                        => 'Hôte',
    'mysql_mysql_host_desc'                   => "L'hôte de la base de données MySQL.",
    'mysql_mysql_port'                        => 'Port',
    'mysql_mysql_port_desc'                   => 'Le port de la base de données MySQL où une connexion peut être mis en place.',
    ...
    'mysql_mysql_username'                    => "Nom d'utilisateur",
    'mysql_mysql_username_desc'               => "Un nom d'utilisateur qui a lu des autorisations sur la collection fournie. Sécurité d'abord, assurez-vous que l'utilisateur a lu des autorisations uniquement.",
    'mysql_mysql_password'                    => 'Mot de passe',
    'mysql_mysql_password_desc'               => "Le mot de passe pour l'utilisateur qui a les autorisations de lecture.",
    ...
    'mysql_map_property'                => 'Propriété geo',
...
                                 La propriété sélectionnée sera utilisée comme identifiant unique sur les objets qui seront mises en correspondance avec le format de sortie",
    ...
    'elasticsearch_description_desc'    => "Le texte descriptif ou d'information qui fournit un certain contexte pour vous publié des ensembles de données.",
    'elasticsearch_host'                => 'Hôte',
    'elasticsearch_host_desc'           => "L'hôte d'Elasticsearch.",
    'elasticsearch_es_type'             => 'Type',
    'elasticsearch_es_type_desc'        => "Le type de données à l'intérieur de l'index.",
    'elasticsearch_es_index'            => 'Index',
    'elasticsearch_es_index_desc'       => "Le nom de l'index Elasticsearch.",
    'elasticsearch_port'                => 'Port',
    'elasticsearch_port_desc'           => 'Le port de la Elasticsearch.',
    'elasticsearch_username'            => "Nom d'utilisateur",
    'elasticsearch_username_desc'       => "Un nom d'utilisateur qui a lu des autorisations sur la collection fournie. Sécurité d'abord, assurez-vous que l'utilisateur a lu des autorisations uniquement.",
