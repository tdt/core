...
class Definition extends Eloquent{
    ...
    protected $fillable = array('resource_name', 'collection_uri', 'source_id', 'source_type', 'title','description','date','type','format','source','language','rights', 'cache_minutes', 'draft');
