...
abstract class TabularBaseRepository extends BaseDefinitionRepository{
    ...
    public function update($id, array $input){
        ...
        $model_definition = $this->getById($id);
        ...
        $this->tabular_repository->deleteBulk($id, $model_name);
        $this->geo_repository->deleteBulk($id, $model_name);

        // Store the columns and geo meta-data
        $this->tabular_repository->storeBulk($id, $model_name, $columns);

        if(!empty($geo)){
            $this->geo_repository->storeBulk($id, $model_name, $geo);
        }
