...
class ResList extends ResResource {
     ...
     * @access	private
     */
    private function _getRestElement($listElement) {
     ...
     *
     * If no $index is suplied, the last list element will be returned

     * @param	integer	$index
     * @return	object ResResource 
     * @access	private
     */
    private function _getListElement($index = null) {
        $element = $this;
        $actualIndex = 0;
        //echo 'index:'.$actualIndex.'<br>';
        while ($element != null) {
     ...
     * @access	private
     */
    private function _getValue($listResource) {
